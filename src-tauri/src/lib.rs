...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            integrations::github::github_device_flow_start,
            integrations::github::github_device_flow_poll,
            integrations::github::generate_pr_body,
            integrations::github::clone_repo_from_url,
